	      	...
	      	<div class="bs-docs-section">
	      		...
	      		<ul style="margin-bottom: 50px">
	      			<li style="margin-top:10px; margin-bottom: 10px">
	      				...
	      				Per temes <strong>esportius</strong> contacta amb <strong>Paco López</strong> (699690738 - <a href="mailto:pacolopez8@hotmail.com" target="_top">pacolopez8@hotmail.com</a>)
	      			</li>
	      			<li style="margin-top:10px; margin-bottom: 10px">
